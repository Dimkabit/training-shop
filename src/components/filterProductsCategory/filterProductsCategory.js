...
function FilterProductsCategory (productsCategory) {
    const filterСategory = productsCategory.filterСategory;

    return (

        <section className={classNames("filter container", {visible: productsCategory.isMenuOpen})} data-test-id={`filters-${productsCategory.productType}`}>
            <div className='filter-block' data-test-id='filters-color'>
                <span className='filter-title'>COLOR</span>
                {productsCategory.colorsProduct.map((color, i) => (
                    <div className='filter-color' key={i} data-test-id={`filter-color-${color}`}>
            ...
            <div className='filter-block' data-test-id='filters-size'>
                ...
                {productsCategory.sizesProduct.map((size, i) => (
                    <div className='filter-color' key={i} data-test-id={`filter-size-${size}`}>
            ...
            <div className='filter-block' data-test-id='filters-brand'>
                ...
                {productsCategory.brandsProduct.map((brand, i) => (
                    <div className='filter-color' key={i} data-test-id={`filter-brand-${brand}`}>
            ...
            <div className='filter-block'>
                ...
                {productsCategory.priceProduct.map((price, i) => (
                    <div className='filter-color' key={i}>
